...
module.exports = function () {
    ...
    prePulishSrc({
        ...
        outputPath: path.resolve(ecDir, 'cms_data.html.js'),
        preamble: preamble.js
    });
    prePulishSrc({
        inputPath: path.resolve(ecDir, 'echarts.common.js'),
        outputPath: path.resolve(ecDir, 'cms_data.html.common.js'),
        preamble: preamble.js
    });
    prePulishSrc({
        inputPath: path.resolve(ecDir, 'echarts.simple.js'),
        outputPath: path.resolve(ecDir, 'cms_data.html.simple.js'),
        preamble: preamble.js
    });
